...
const FIRST_NAME = 'Danilo';
const LAST_NAME = 'Kaltner';
const GITHUB_USERNAME = 'Kaltner';
const TWITTER_USERNAME = 'DaniloKaltner';
const LINKEDIN_USERNAME = 'danilokaltner';
const PHONE_NUMBER = '604-XXX-XXXX';
const ADDRESS = 'Vancouver';
const EMAIL = 'danilo.kaltner@gmail.com';
